...
public class RulesOf6005 {
	...
	public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
	    ...
	    // If the code was written by you (or your teammates), you can use it.
	    if (writtenByYourself) {
	        return true;
	    }

	    // If the code is not yours, but is available to everyone, it can be used.
	    if (availableToOthers) {
	        // If it was written specifically for coursework, you can't use it.
	        if (writtenAsCourseWork) {
	            return false;
	        }
	        // If you properly cite your source, you can use it.
	        return citingYourSource;
	    }
	    
	    // If it’s not yours, not available to others, and not cited, you can’t use it.
	    return false;
	}
